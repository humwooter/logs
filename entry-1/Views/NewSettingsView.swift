...
//                },
//                icon: { 
//                    settingsIconView(systemImage: "paintpalette.fill", color: userPreferences.accentColor)}
//            )
//        }
...
//    @State private var totalSize = 0.0
//    @State private var photoSize = 0.0
//    @State private var pdfSize = 0.0
//
//    var body: some View {
//        VStack {
//            Text("Total Size: \(totalSize, specifier: "%.2f") MB")
//            Text("Photo Size: \(photoSize, specifier: "%.2f") MB")
//            Text("PDF Size: \(pdfSize, specifier: "%.2f") MB")
//            Button("Calculate Size") {
//                let documentsURL = getDocumentsDirectory()
//                totalSize = calculateDirectorySize(url: documentsURL)
//                photoSize = calculateSizeForExtensions(url: documentsURL, extensions: ["jpg", "png", "gif"])
//                pdfSize = calculateSizeForExtensions(url: documentsURL, extensions: ["pdf"])
//            }
//        }
//    }
//}
