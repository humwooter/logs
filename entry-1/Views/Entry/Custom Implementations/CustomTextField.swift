...
//                let linkedText = context.coordinator.makeAttributedStringWithLinks(from: mutableAttributedString.string)
//                mutableAttributedString.setAttributedString(NSAttributedString(linkedText))
//            }
//            
...
//                let linkedText = makeAttributedStringWithLinks(from: mutableAttributedString.string)
//                mutableAttributedString.setAttributedString(NSAttributedString(linkedText))
//            }
//            
//            DispatchQueue.main.async { [weak self] in
...
//                self.parent.viewModel.attributedText = mutableAttributedString
//                
//                let newSelectedRange = NSRange(location: min(textView.selectedRange.location, mutableAttributedString.length), length: 0)
//                textView.selectedRange = newSelectedRange
//                self.parent.cursorPosition = newSelectedRange
//                self.parent.viewModel.updateSelectedRange(newSelectedRange)
//            }
