////
////  AlternateNewEntryView.swift
////  entry-1
////
////  Created by Katyayani G. Raman on 4/29/24.
////
//
//
//import Foundation
...
//    @State private var columns: [GridItem] = Array(repeating: .init(.flexible()), count: 4)  // Default to 3 columns
//
//    
//    
//    
...
//    @State private var selectedMedia: [UUID: Data] = [:]
...
//                        
//        
//                        textFieldView().frame(maxHeight: 800)
//                    }
//                    .onTapGesture {
//                        focusField = true
//                    }
...
//    }
//    
//    func deleteContextMenu(_ key: UUID) -> some View {
//        Group {
//            Button(role: .destructive, action: {
//                // Remove the specific item from the dictionary using its key
//                selectedMedia.removeValue(forKey: key)
//            }) {
//                Text("Delete")
...
//    }
//    
//    private func numberOfRows(columns: Int) -> Int {
//        let totalItems = selectedMedia.count
//        return (totalItems + columns - 1) / columns // Calculates the number of full rows needed
//    }
//
//    @ViewBuilder
//      func entryMediaViews() -> some View {
//          let totalItems = selectedMedia.count
//          let columns: [GridItem] = Array(repeating: .init(.fixed(1)), count: max(min(totalItems, 4), 1))
//
//          LazyVGrid(columns: columns, spacing: 5) {
//              ForEach(selectedMedia.keys.sorted(), id: \.self) { key in
//                  if let data = selectedMedia[key] {
//                      ZStack(alignment: .topTrailing) {
//                          mediaView(data: data, key: key)
//                          deleteButton(key: key)
//                      }
//                      .frame(minWidth:  150/CGFloat(columns.count),  maxWidth: .infinity, minHeight: 150/CGFloat(columns.count), maxHeight: 150)
////                      .scaledToFit()
////                          .frame(minWidth: 0, maxWidth: .infinity, minHeight: 0, maxHeight: CGFloat(numberOfRows(columns: columns.count)) * 100)
//                      .cornerRadius(15)
//                      .padding()
//                  }
//              }
...
////          .frame(minWidth: 0, maxWidth: .infinity, minHeight: 0, maxHeight: CGFloat(numberOfRows(columns: columns.count)) * 100)
////          .scaledToFit()
//////          .frame(minWidth: 0, maxWidth: .infinity, minHeight: 0, maxHeight: columns.count * 300)
//////          .scaledToFit()
//////          .frame(minWidth: 0, maxWidth: .infinity, minHeight: 0, maxHeight: 1/CGFloat(columns.count) * 70)
//////          .padding(10)
//////          .cornerRadius(15)
////          .padding(10)
//      }
//
//      @ViewBuilder
//      private func mediaView(data: Data, key: UUID) -> some View {
//          if isGIF(data: data) {
//              AnimatedImageView_data(data: data)
//                  .contextMenu { deleteContextMenu(key) }
//          } else if isPDF(data: data) {
//              PDFKitView(data: data)
//                  .contextMenu { deleteContextMenu(key) }
//          } else {
//              CustomAsyncImageView_uiImage(image: UIImage(data: data)!)
...
//
//      @ViewBuilder
//      private func deleteButton(key: UUID) -> some View {
//          Button(action: {
//              vibration_light.impactOccurred()
//              selectedMedia.removeValue(forKey: key)
//          }) {
...
//                    let uuid = UUID()  // Generate a unique identifier for each item
//                    DispatchQueue.main.async {
//                        selectedMedia[uuid] = data
//                    }
//                }
//            }
//            selectedItems = []
...
////                    for item in selectedItems {
////                        if let data = try? await item.loadTransferable(type: Data.self) {
////                            selectedData = data //get rid of this
////                            selectedMedia.insert(data)
