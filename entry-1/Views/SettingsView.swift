...
//                        .padding(1)
//                }
//                ColorPicker("Entry background:", selection: $userPreferences.entryBackgroundColor)
//            }
//            .padding()
//        } header: {
//            HStack {
//                Text("Entry Background Color").foregroundStyle(UIColor.foregroundColor(background: UIColor(userPreferences.backgroundColors.first ?? Color.gray))).opacity(0.4)
//                    .font(.system(size: UIFont.systemFontSize))
//            }
//        }
//
