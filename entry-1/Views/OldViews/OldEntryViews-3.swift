...
//                                                    deleteImage() //clear previous image data only if it exists
//                                                }
//                                                selectedData = data
//                                                let documentsDirectory = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first!
...
//
//                                }
//                                .foregroundColor(UIColor.foregroundColor(entry: entry, background: entry.color, colorScheme: colorScheme)) //to determinw whether black or white
//
//                            }
//
//
...
////
////            entry.content = editingContent
////            // entry.imageContent was already set in the photoPicker
////
//////            // Save the context
...
////            do {
////                try coreDataManager.save(context: backgroundContext)
////            } catch let error as NSError {
////                print("Could not save. \(error), \(error.userInfo)")
////            }
////            do {
////                try coreDataManager.mergeChanges(from: backgroundContext)
////            } catch let error as NSError {
////                print("Could not merge changes. \(error), \(error.userInfo)")
////            }
////        }
////        isEditing = false
////        focusField = false
...
//}
////    func deleteImage() {
////        print("entry from deleteImage: \(entry)")
////        let backgroundContext = coreDataManager.backgroundContext
////        backgroundContext.performAndWait {
////            if let filename = entry.imageContent, !filename.isEmpty {
////                let documentsDirectory = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first!
////                let fileURL = documentsDirectory.appendingPathComponent(filename)
////
////                do {
