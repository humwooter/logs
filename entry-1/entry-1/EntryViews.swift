    ...
    private func backgroundColor(entry: Entry) -> Color {
        ...
        for index in 0..<5 {
            if entry.buttons[index] {
                ...
                print("color being returned: \(color) with index: \(index)")
