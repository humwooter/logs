...
let imageCategories: [String: [String]] = [
    ...
    "Fitness": ["gym.bag.fill", "dumbbell.fill", "surfboard.fill", "snowboard.fill", "volleyball.fill", "tennis.racket", "basketball.fill", "baseball.fill", "soccerball", "football", "football.fill", "figure.climbing", "figure.archery", "figure.skiing.crosscountry", "figure.cricket", "figure.skiing.downhill", "figure.fencing", "figure.hockey", "figure.jumprope"],
    ...
    "Tools": ["wrench.adjustable.fill", "hammer.fill", "eyedropper.halffull", "screwdriver.fill", "wrench.and.screwdriver.fill", "stethoscope", "compass.drawing", "shield.fill", "pencil.and.ruler.fill"],
